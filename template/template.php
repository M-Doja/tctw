        ...
        <article class="col-md-6">
          ...
          <section id="ctw-page" class="pdfImg btn1">
            <a href="#" data-toggle="modal" data-target="#settingCTWModal" class="modal-launcher">
              ...
              <img id="ctwImg"src="./content/assets/images/2018 Recent book Page 11Center of the World.jpg" alt="Image of typed paper about the Center of The World" height="200px">
            </a>
            <!-- Modal -->
              ...
              <div class="modal-dialog" role="document" style="max-width:732px; width:100%;">
                <div class="modal-content" >
                  <div class="modal-body">
                    <img id="" src="./content/assets/images/2018 Recent book Page 11Center of the World.jpg"  />
                  </div>
